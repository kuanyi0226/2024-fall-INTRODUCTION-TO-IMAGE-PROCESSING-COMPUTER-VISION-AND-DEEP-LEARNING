...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.loaded_image_path_q1 = None  # For Q1 loaded image path
        self.loaded_image_path_q2 = None  # For Q2 loaded image path
        self.initUI()
    ...
    def initUI(self):
        ...
        self.q2_1_btn.clicked.connect(train.show_inference_images)
        self.q2_2_btn.clicked.connect(train.show_resnet50_architecture)
        self.q2_3_btn.clicked.connect(train.compare_resnet50_models)
    ...
    def q2_inference(self):
        ...
        result = train.predict_with_resnet50("model/resnet50_no_erasing.pth", self.loaded_image_path_q2)
        if result is not None:
